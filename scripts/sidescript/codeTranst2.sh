...
testOneProgram() {
    ...
    cp /root/sseq/compile_commands/tcpdump-master/compile_commands.json "$programDir/compile_commands.json"

    echo "running clang-tidy"
    clang-tidy $programName -checks=readability-braces-around-statements -fix
    ...
    #res=`$SSEQ $programName div %any% mut 2>1`
